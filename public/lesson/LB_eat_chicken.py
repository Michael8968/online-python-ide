...
bac1 = pygame.image.load("lessonB/image/场景2/背景22.png")
bac1 = pygame.transform.smoothscale(bac1, (960, 720))
propImg = pygame.image.load("lessonB/image/场景2/道具2.png")
propImg = pygame.transform.smoothscale(propImg, (960, 720))
peopleBulletImg = pygame.image.load("lessonB/image/场景2/玩家子弹.png")
peopleBulletImg = pygame.transform.smoothscale(peopleBulletImg, (28, 16))
enemyBulletImg = pygame.image.load("lessonB/image/场景2/敌人子弹.png")
...
signImg1 = pygame.image.load("lessonB/image/标志1.png")
signImg1 = pygame.transform.smoothscale(signImg1, (134, 154))
signImg2 = pygame.image.load("lessonB/image/标志2.png")
...
for i in range(4):
    enemyImg1 = pygame.image.load("lessonB/image/角色/敌人4/" + str(i + 1) + ".png")
...
for i in range(4):
    enemyImg2 = pygame.image.load("lessonB/image/角色/敌人5/" + str(i + 1) + ".png")
