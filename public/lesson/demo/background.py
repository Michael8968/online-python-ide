...
class Back(pygame.sprite.Sprite):
    def __init__(self,position,bg_size):
        ...
        self.width,self.height = bg_size[0],bg_size[1]
                ...
                #设置子弹对象
        self.image = pygame.image.load('image/ui/image_1.jpg').convert_alpha()
        self.images = []
        self.images.extend([pygame.image.load('image/ui/image_2.jpg').convert_alpha(),pygame.image.load('image/ui/image_3.jpg').convert_alpha(),pygame.image.load('image/ui/image_4.jpg').convert_alpha(),pygame.image.load('image/ui/image_5.jpg').convert_alpha()])
