    ...
    this.marker.update = function(html, markerLayer, session, config) {
      ...
      for (let i = 0; i < cursors.length; i++) {
        ...
        if (pos.row < start) {
          ...
          let aceGutter = document.getElementsByClassName('ace_gutter')[0]
            .offsetWidth
...
export class AceBinding {
  ...
  constructor(type, ace, awareness) {
    ...
    this._cursorObserver = this._cursorObserver.bind(this)
    this._typeObserver = this._typeObserver.bind(this)
    this._aceObserver = this._aceObserver.bind(this)
  }
